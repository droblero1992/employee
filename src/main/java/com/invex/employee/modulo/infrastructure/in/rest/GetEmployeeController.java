...
public class GetEmployeeController {
    ...
    @GetMapping
    public ResponseEntity<EmployeePageResult<EmployeeDTO>> getAll(@NotNull @RequestParam("page") Integer page, @NotNull @RequestParam("size") Integer size) {
        ...
        List<EmployeeDTO> items = Optional.of(employees)
                .map(emp -> emp.stream()
